...
(define-public (set-usage-as-collateral-enabled (asset principal) (enabled bool))
  (let (
    (reserve-data (get-reserve-state asset))
  )
    (ok (map-set reserve-state asset (merge reserve-data { usage-as-collateral-enabled: enabled })))
  )
)
