...
;; ;; exchange rate between two assets in precision 8
...
(define-private (claim-rewards-priv
    ...
    (begin
        (asserts! (is-eq who tx-sender) (err u1000))
        ;; increase income
        ...
        (let (
            ...
            ;; before claiming, but already withdrew everything
            (if (> reward-balance u0)
