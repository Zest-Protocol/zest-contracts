...
(define-constant diko-token .diko)
(define-constant diko-z-token .zdiko-v1-2)
...
(define-public (run-update)
  (begin
    ...
    (try! (contract-call? .zdiko-v1-2 set-approved-contract .pool-borrow-v1-2 true))
    (try! (contract-call? .zdiko-v1-2 set-approved-contract .liquidation-manager-v1-2 true))
    (try! (contract-call? .zdiko-v1-2 set-approved-contract .pool-0-reserve-v1-2 true))
