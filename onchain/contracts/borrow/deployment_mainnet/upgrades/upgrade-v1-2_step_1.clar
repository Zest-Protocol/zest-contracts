...
(define-public (run-update)
  (begin
    ...
    (try! (contract-call? .pool-reserve-data delete-user-reserve-data 'SP3M742Y46SFSXHQD0WE31V60GMYP8KWTJWE5CY2B))
    (try! (contract-call? .pool-reserve-data delete-user-reserve-data 'SP1XSX76A3JS054PM65VBE718K049AEJSVRKWZP1Z))
    (try! (contract-call? .pool-reserve-data delete-user-reserve-data 'SP2HDXKPHMMH5FP9NY542GBFJESXMN1P0SNM3MN0X))
    (try! (contract-call? .pool-reserve-data delete-user-reserve-data 'SP22S1EVQ2A8ED2861TTKJJHHDCTRKP39H6R29WHN))
    (try! (contract-call? .pool-reserve-data delete-user-reserve-data 'SP9DGFSPRX40H5BS19RHNCQXSFC1H6Z7PCFNW17C))

    (try! (contract-call? .pool-reserve-data delete-user-index 'SP3M742Y46SFSXHQD0WE31V60GMYP8KWTJWE5CY2B))
    (try! (contract-call? .pool-reserve-data delete-user-index 'SP1XSX76A3JS054PM65VBE718K049AEJSVRKWZP1Z))
    (try! (contract-call? .pool-reserve-data delete-user-index 'SP2HDXKPHMMH5FP9NY542GBFJESXMN1P0SNM3MN0X))
    (try! (contract-call? .pool-reserve-data delete-user-index 'SP22S1EVQ2A8ED2861TTKJJHHDCTRKP39H6R29WHN))
    (try! (contract-call? .pool-reserve-data delete-user-index 'SP9DGFSPRX40H5BS19RHNCQXSFC1H6Z7PCFNW17C))
