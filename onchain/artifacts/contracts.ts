...
export namespace Zgp002OnboardBorrowerContract {
    export const address = "ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM";
    export const name = "zgp002-onboard-borrower";
...
export namespace Zgp005CreatePool1Contract {
    export const address = "ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM";
    export const name = "zgp005-create-pool-1";
...
export namespace SupplierController0Contract {
    export const address = "ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM";
    export const name = "supplier-controller-0";
    ...
    export namespace Functions {
        ...
        // finalize-swap-completed
        export namespace FinalizeSwapCompleted {
            export const name = "finalize-swap-completed";

            export interface FinalizeSwapCompletedArgs {
                txid: BufferCV,
            }

            export function args(args: FinalizeSwapCompletedArgs): ClarityValue[] {
                return [
                    args.txid,
                ];
            }
...
export namespace SupplierInterfaceContract {
    ...
    export namespace Functions {
        ...
        // drawdown-verify
        export namespace DrawdownVerify {
            export const name = "drawdown-verify";

            export interface DrawdownVerifyArgs {
                loanId: UIntCV,
                lpToken: ClarityValue,
                tokenId: UIntCV,
                collToken: ClarityValue,
            ...
            export function args(args: DrawdownVerifyArgs): ClarityValue[] {
                return [
                    args.loanId,
                    args.lpToken,
                    args.tokenId,
        ...
        // make-full-payment-completed
        export namespace MakeFullPaymentCompleted {
            export const name = "make-full-payment-completed";

            export interface MakeFullPaymentCompletedArgs {
                txid: BufferCV,
                payment: ClarityValue,
                lpToken: ClarityValue,
                lv: ClarityValue,
            ...
            export function args(args: MakeFullPaymentCompletedArgs): ClarityValue[] {
                return [
                    args.txid,
                    args.payment,
                    args.lpToken,
        ...
        export namespace MakePaymentCompleted {
            export const name = "make-payment-completed";

            export interface MakePaymentCompletedArgs {
                txid: BufferCV,
                payment: ClarityValue,
                lpToken: ClarityValue,
                lv: ClarityValue,
            ...
            export function args(args: MakePaymentCompletedArgs): ClarityValue[] {
                return [
                    args.txid,
                    args.payment,
                    args.lpToken,
        ...
        // make-payment-verify
        export namespace MakePaymentVerify {
            export const name = "make-payment-verify";

            export interface MakePaymentVerifyArgs {
                txid: BufferCV,
                payment: ClarityValue,
                lpToken: ClarityValue,
                lv: ClarityValue,
            ...
            export function args(args: MakePaymentVerifyArgs): ClarityValue[] {
                return [
                    args.txid,
                    args.payment,
                    args.lpToken,
        ...
        // make-payment-verify-completed
        export namespace MakePaymentVerifyCompleted {
            export const name = "make-payment-verify-completed";

            export interface MakePaymentVerifyCompletedArgs {
                txid: BufferCV,
                payment: ClarityValue,
                lpToken: ClarityValue,
                lv: ClarityValue,
            ...
            export function args(args: MakePaymentVerifyCompletedArgs): ClarityValue[] {
                return [
                    args.txid,
                    args.payment,
                    args.lpToken,
        ...
        // make-residual-payment-completed
        export namespace MakeResidualPaymentCompleted {
            export const name = "make-residual-payment-completed";

            export interface MakeResidualPaymentCompletedArgs {
                txid: BufferCV,
                lpToken: ClarityValue,
                lv: ClarityValue,
                xbtcFt: ClarityValue,
            ...
            export function args(args: MakeResidualPaymentCompletedArgs): ClarityValue[] {
                return [
                    args.txid,
                    args.lpToken,
                    args.lv,
        ...
        // send-funds-finalize-completed
        export namespace SendFundsFinalizeCompleted {
            export const name = "send-funds-finalize-completed";

            export interface SendFundsFinalizeCompletedArgs {
                txid: BufferCV,
                lpToken: ClarityValue,
                zpToken: ClarityValue,
                lv: ClarityValue,
            ...
            export function args(args: SendFundsFinalizeCompletedArgs): ClarityValue[] {
                return [
                    args.txid,
                    args.lpToken,
                    args.zpToken,
        ...
        // send-funds-to-pool
        export namespace SendFundsToPool {
            export const name = "send-funds-to-pool";

            export interface SendFundsToPoolArgs {
                txid: BufferCV,
                lpToken: ClarityValue,
                zpToken: ClarityValue,
                lv: ClarityValue,
            ...
            export function args(args: SendFundsToPoolArgs): ClarityValue[] {
                return [
                    args.txid,
                    args.lpToken,
                    args.zpToken,
...
export namespace MagicCallerST3Contract {
    export const address = "ST3NBRSFKX28FQ2ZJ1MAKX58HKHSDGNV5N7R21XCP";
    export const name = "magic-caller-ST3";

    // Functions
    export namespace Functions {
        // commit-funds
        export namespace CommitFunds {
            export const name = "commit-funds";

            export interface CommitFundsArgs {
                block: TupleCV,
                prevBlocks: ListCV,
                tx: BufferCV,
                proof: TupleCV,
            ...
            export function args(args: CommitFundsArgs): ClarityValue[] {
                return [
                    args.block,
                    args.prevBlocks,
                    args.tx,
        ...
        // make-payment-loan
        export namespace MakePaymentLoan {
            export const name = "make-payment-loan";

            export interface MakePaymentLoanArgs {
                txid: BufferCV,
                preimage: BufferCV,
                payment: ClarityValue,
                lpToken: ClarityValue,
            ...
            export function args(args: MakePaymentLoanArgs): ClarityValue[] {
                return [
                    args.txid,
                    args.preimage,
                    args.payment,
        ...
        // make-payment-loan-completed
        export namespace MakePaymentLoanCompleted {
            export const name = "make-payment-loan-completed";

            export interface MakePaymentLoanCompletedArgs {
                txid: BufferCV,
                payment: ClarityValue,
                lpToken: ClarityValue,
                lv: ClarityValue,
            ...
            export function args(args: MakePaymentLoanCompletedArgs): ClarityValue[] {
                return [
                    args.txid,
                    args.payment,
                    args.lpToken,
        ...
        // send-funds-to-pool-completed
        export namespace SendFundsToPoolCompleted {
            export const name = "send-funds-to-pool-completed";

            export interface SendFundsToPoolCompletedArgs {
                txid: BufferCV,
                lpToken: ClarityValue,
                zpToken: ClarityValue,
                lv: ClarityValue,
            ...
            export function args(args: SendFundsToPoolCompletedArgs): ClarityValue[] {
                return [
                    args.txid,
                    args.lpToken,
                    args.zpToken,
...
export namespace PaymentFixedContract {
    ...
    export namespace Functions {
        ...
        // get-early-repayment-fee
        export namespace GetEarlyRepaymentFee {
            export const name = "get-early-repayment-fee";

            export interface GetEarlyRepaymentFeeArgs {
                tokenId: UIntCV,
            }

            export function args(args: GetEarlyRepaymentFeeArgs): ClarityValue[] {
                return [
                    args.tokenId,
                ];
            }
        ...
        // get-late-fee
        export namespace GetLateFee {
            export const name = "get-late-fee";

            export interface GetLateFeeArgs {
                tokenId: UIntCV,
            }

            export function args(args: GetLateFeeArgs): ClarityValue[] {
                return [
                    args.tokenId,
                ];
            }
...
export namespace PoolV10Contract {
    ...
    export namespace Functions {
        ...
        // is-ready
        export namespace IsReady {
            export const name = "is-ready";

            export interface IsReadyArgs {
                tokenId: UIntCV,
            }

            export function args(args: IsReadyArgs): ClarityValue[] {
                return [
                    args.tokenId,
                ];
            }
...
export namespace MagicCallerST1Contract {
    export const address = "ST1SJ3DTE5DN7X54YDH5D64R3BCB6A2AG2ZQ8YPD5";
    export const name = "magic-caller-ST1";
...
export namespace Zgp004AddPoolAdminContract {
    export const address = "ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM";
    export const name = "zgp004-add-pool-admin";
...
export namespace LoanV10Contract {
    ...
    export namespace Functions {
        ...
        // get-tested-amount
        export namespace GetTestedAmount {
            export const name = "get-tested-amount";

            export interface GetTestedAmountArgs {
                loanId: UIntCV,
            }

            export function args(args: GetTestedAmountArgs): ClarityValue[] {
                return [
                    args.loanId,
                ];
            }
...
export namespace SupplierControllerTraitContract {
    export const address = "ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM";
    export const name = "supplier-controller-trait";
...
export namespace Zgp003UpdatePaymentFeeContract {
    export const address = "ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM";
    export const name = "zgp003-update-payment-fee";
