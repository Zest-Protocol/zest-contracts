...
class SupplierInterface {
  ...
  static sendFundsFinalizeCompleted(
    txid: string,
    factor: number,
    lpToken: string,
    tokenId: number,
  ...
  static makePaymentVerifyCompleted(
    txid: string,
    loanId: number,
    payment: string,
    lpToken: string,
  ...
  static makeResidualPaymentCompleted(
    txid: string,
    loanId: number,
    lpToken: string,
    lv: string,
  ...
  static makeFullPaymentCompleted(
    txid: string,
    loanId: number,
    payment: string,
    lpToken: string,
